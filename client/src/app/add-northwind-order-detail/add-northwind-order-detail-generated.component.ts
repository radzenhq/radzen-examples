/*
  ...
  Modify add-northwind-order-detail.component.ts instead.
*/
...
export class AddNorthwindOrderDetailGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.northwind.createNorthwindOrderDetail(event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
