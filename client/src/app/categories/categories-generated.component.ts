...
export class CategoriesGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getCategories(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, null, this.grid0.allowPaging, null, null)
  ...
  grid0LoadData(event: any) {
    this.northwind.getCategories(`${event.filter}`, event.top, event.skip, `${event.orderby}`, ``, event.top != null && event.skip != null, null, null)
    .subscribe((result: any) => {
      this.getCategoriesResult = result.value;
