/*
  ...
  Modify northwind-products.component.ts instead.
*/
...
export class NorthwindProductsGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.northwind.getNorthwindProducts(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, `Supplier,Category`, this.grid0.allowPaging)
