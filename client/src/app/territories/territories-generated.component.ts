...
export class TerritoriesGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getTerritories(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, `Region`, this.grid0.allowPaging, null, null)
  ...
  grid0LoadData(event: any) {
    this.northwind.getTerritories(`${event.filter}`, event.top, event.skip, `${event.orderby}`, `Region`, event.top != null && event.skip != null, null, null)
    .subscribe((result: any) => {
      this.getTerritoriesResult = result.value;
