...
export class ProductsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.sample.getProducts(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, null, null, null)
  ...
  grid0LoadData(event: any) {
    this.sample.getProducts(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, ``, null, null)
    .subscribe((result: any) => {
      this.getProductsResult = result.value;
