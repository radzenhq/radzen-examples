  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new MultiTenantSample.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new MultiTenantSample.Data.XlsDataContractSerializerOutputFormatter());
      });
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<MultiTenantSample.Models.Sample.Order>("Orders");
          oDataBuilder.EntitySet<MultiTenantSample.Models.Sample.OrderDetail>("OrderDetails");
          oDataBuilder.EntitySet<MultiTenantSample.Models.Sample.Product>("Products");
