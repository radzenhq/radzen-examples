...
using InvokeCustomServerMethod.Data;

namespace InvokeCustomServerMethod
{
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new InvokeCustomServerMethod.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new InvokeCustomServerMethod.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<InvokeCustomServerMethod.Data.SampleContext>(options =>
      {
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<InvokeCustomServerMethod.Models.Sample.Order>("Orders");
          oDataBuilder.EntitySet<InvokeCustomServerMethod.Models.Sample.OrderDetail>("OrderDetails");
          oDataBuilder.EntitySet<InvokeCustomServerMethod.Models.Sample.Product>("Products");
