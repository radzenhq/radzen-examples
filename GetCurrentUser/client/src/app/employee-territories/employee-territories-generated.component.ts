...
export class EmployeeTerritoriesGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getEmployeeTerritories(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Employee,Territory`, null, null)
  ...
  grid0LoadData(event: any) {
    this.northwind.getEmployeeTerritories(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Employee,Territory`, null, null)
    .subscribe((result: any) => {
      this.getEmployeeTerritoriesResult = result.value;
