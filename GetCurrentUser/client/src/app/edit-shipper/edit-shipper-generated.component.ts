/*
  ...
  Modify edit-shipper.component.ts instead.
*/
...
export class EditShipperGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.northwind.getShipperByShipperId(this.parameters.ShipperID)
  ...
  form0Submit(event: any) {
    this.northwind.updateShipper(this.parameters.ShipperID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Shipper` });
    });
  }
}
