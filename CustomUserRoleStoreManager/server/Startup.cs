  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new CustomUserRoleStoreManager.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new CustomUserRoleStoreManager.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<CustomUserRoleStoreManager.Data.NorthwindContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("NorthwindConnection"));
      });
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Category>("Categories");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Customer>("Customers");

          var customerCustomerDemo = oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.CustomerCustomerDemo>("CustomerCustomerDemos");
          customerCustomerDemo.EntityType.HasKey(entity => new {
            entity.CustomerID, entity.CustomerTypeID
          });
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.CustomerDemographic>("CustomerDemographics");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Employee>("Employees");

          var employeeTerritory = oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.EmployeeTerritory>("EmployeeTerritories");
          employeeTerritory.EntityType.HasKey(entity => new {
            entity.EmployeeID, entity.TerritoryID
          });
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Order>("Orders");

          var orderDetail = oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.OrderDetail>("OrderDetails");
          orderDetail.EntityType.HasKey(entity => new {
            entity.OrderID, entity.ProductID
          });
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Product>("Products");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Region>("Regions");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Shipper>("Shippers");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Supplier>("Suppliers");
          oDataBuilder.EntitySet<CustomUserRoleStoreManager.Models.Northwind.Territory>("Territories");
