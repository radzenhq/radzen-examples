/*
  ...
  Modify edit-customer-demographic.component.ts instead.
*/
...
export class EditCustomerDemographicGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    ...
    this.northwind.getCustomerDemographicByCustomerTypeId(`${this.parameters.CustomerTypeID}`)
    .subscribe((result: any) => {
      this.customerdemographic = result;
    }, (result: any) => {
  ...
  form0Submit(event: any) {
    this.northwind.updateCustomerDemographic(`${this.parameters.CustomerTypeID}`, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update CustomerDemographic` });
    });
  }
}
