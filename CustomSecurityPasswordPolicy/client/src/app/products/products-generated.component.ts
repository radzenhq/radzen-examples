...
export class ProductsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getProducts(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Supplier,Category`, null, null)
  ...
  grid0LoadData(event: any) {
    this.northwind.getProducts(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Supplier,Category`, null, null)
    .subscribe((result: any) => {
      this.getProductsResult = result.value;
  ...
  grid0Delete(event: any) {
    this.northwind.deleteProduct(event.ProductID)
    .subscribe((result: any) => {
