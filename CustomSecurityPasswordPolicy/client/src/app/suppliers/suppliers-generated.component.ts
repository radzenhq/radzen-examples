...
export class SuppliersGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getSuppliers(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, null, null, null)
