...
namespace NgSelectDataGridCheckBox
{
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new NgSelectDataGridCheckBox.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new NgSelectDataGridCheckBox.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<NgSelectDataGridCheckBox.Data.SampleContext>(options =>
      {
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<NgSelectDataGridCheckBox.Models.Sample.Order>("Orders");
          oDataBuilder.EntitySet<NgSelectDataGridCheckBox.Models.Sample.OrderDetail>("OrderDetails");
          oDataBuilder.EntitySet<NgSelectDataGridCheckBox.Models.Sample.Product>("Products");
