...
using CustomSecurity.Authentication;
  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new CustomSecurity.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new CustomSecurity.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      {
         options.UseSqlServer(Configuration.GetConnectionString("CustomSecurityConnection"));
      });
      ...
      services.AddDbContext<CustomSecurity.Data.CustomSecurityContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("CustomSecurityConnection"));
      });
