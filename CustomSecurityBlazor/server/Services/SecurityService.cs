...
namespace CustomSecurity
{
    public partial class SecurityService
    {
        ...
        public SecurityService(CustomSecurityDbContext context,
        ...
        public CustomSecurityDbContext context { get; set; }
        ...
        public async Task<IdentityRole> DeleteRole(string id)
        {
            ...
            return new IdentityRole { Name = item.Name, Id = item.Id.ToString() };
        }

        public async Task<IdentityRole> GetRoleById(string id)
        {
            var item = await context.Roles.FindAsync(id);

            return new IdentityRole { Name = item.Name, Id = item.Id.ToString() };
        }
        public async Task<IEnumerable<ApplicationUser>> GetUsers()
        {
            return await context.Users.AsNoTracking().Select(u => new ApplicationUser { Name = u.Email, Id = u.Id.ToString() }).ToListAsync();
        }
        ...
        public async Task<ApplicationUser> DeleteUser(string id)
        {
            ...
            return new ApplicationUser { Name = item.Email, Id = item.Id.ToString() };
        }
