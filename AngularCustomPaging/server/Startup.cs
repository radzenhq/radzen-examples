  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new Sample.Data.XlsDataContractSerializerOutputFormatter());
          ...
          options.OutputFormatters.Add(new Sample.Data.CsvDataContractSerializerOutputFormatter());
      ...
      services.AddDbContext<Sample.Data.SampleContext>(options =>
      {
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<Sample.Models.Sample.Order>("Orders");
          oDataBuilder.EntitySet<Sample.Models.Sample.OrderDetail>("OrderDetails");
          oDataBuilder.EntitySet<Sample.Models.Sample.Product>("Products");
