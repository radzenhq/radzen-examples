...
using ExtendApplicationUser.Authentication;

namespace ExtendApplicationUser
{
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new ExtendApplicationUser.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new ExtendApplicationUser.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<ExtendApplicationUser.Data.NorthwindContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("NorthwindConnection"));
      });
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Category>("Categories");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Customer>("Customers");

          var customerCustomerDemo = oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.CustomerCustomerDemo>("CustomerCustomerDemos");
          customerCustomerDemo.EntityType.HasKey(entity => new {
            entity.CustomerID, entity.CustomerTypeID
          });
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.CustomerDemographic>("CustomerDemographics");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Employee>("Employees");

          var employeeTerritory = oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.EmployeeTerritory>("EmployeeTerritories");
          employeeTerritory.EntityType.HasKey(entity => new {
            entity.EmployeeID, entity.TerritoryID
          });
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Order>("Orders");

          var orderDetail = oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.OrderDetail>("OrderDetails");
          orderDetail.EntityType.HasKey(entity => new {
            entity.OrderID, entity.ProductID
          });
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Product>("Products");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Region>("Regions");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Shipper>("Shippers");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Supplier>("Suppliers");
          oDataBuilder.EntitySet<ExtendApplicationUser.Models.Northwind.Territory>("Territories");
