/*
  ...
  Modify add-customer.component.ts instead.
*/
...
export class AddCustomerGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.northwind.createCustomer(null, event)
