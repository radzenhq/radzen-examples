...
export class OrderDetailsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getNorthwindOrderDetails(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, `NorthwindOrder,NorthwindProduct`, this.grid0.allowPaging, null, null)
  ...
  grid0LoadData(event: any) {
    this.northwind.getNorthwindOrderDetails(`${event.filter}`, event.top, event.skip, `${event.orderby}`, `NorthwindOrder,NorthwindProduct`, event.top != null && event.skip != null, null, null)
    .subscribe((result: any) => {
      this.getNorthwindOrderDetailsResult = result.value;
