...
export class OrdersByEmployeeIdGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.northwind.getOrders(`${event.filter ? event.filter + ' and ' : ''}EmployeeID eq ${this.parameters.EmployeeID}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Customer,Employee,Shipper`, null, null)
