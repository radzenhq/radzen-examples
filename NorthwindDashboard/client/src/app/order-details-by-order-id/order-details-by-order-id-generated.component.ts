...
export class OrderDetailsByOrderIdGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.northwind.getOrderDetails(`${event.filter} and OrderID eq ${this.parameters.OrderID}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Order,Product`, null, null)
