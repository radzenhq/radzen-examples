...
export class EditProductGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    ...
    this.northwind.getProductByProductId(null, this.parameters.ProductID)
    ...
    this.northwind.getSuppliers(null, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
    ...
    this.northwind.getCategories(null, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
  ...
  form0Submit(event: any) {
    this.northwind.updateProduct(null, this.parameters.ProductID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
