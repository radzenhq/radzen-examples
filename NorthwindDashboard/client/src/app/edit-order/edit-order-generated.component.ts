...
export class EditOrderGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    ...
    this.northwind.getOrderByOrderId(null, this.parameters.OrderID)
    ...
    this.northwind.getShippers(null, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
  ...
  form0Submit(event: any) {
    this.northwind.updateOrder(null, this.parameters.OrderID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
