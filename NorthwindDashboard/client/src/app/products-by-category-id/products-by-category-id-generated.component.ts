...
export class ProductsByCategoryIdGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.northwind.getProducts(`${event.filter ? event.filter + ' and ' : ''}CategoryID eq ${this.parameters.CategoryID}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Supplier,Category`, null, null)
