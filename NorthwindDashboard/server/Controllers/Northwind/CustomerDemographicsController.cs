...
namespace Northwind.Controllers.Northwind
{
  ...
  public partial class CustomerDemographicsController : ODataController
  {
    ...
    public SingleResult<CustomerDemographic> GetCustomerDemographic(string key)
    {
        ...
        this.OnCustomerDemographicsGet(ref items);

        return SingleResult.Create(items);
    }

    partial void OnCustomerDemographicsGet(ref IQueryable<Models.Northwind.CustomerDemographic> items);
    ...
    public IActionResult PutCustomerDemographic(string key, [FromBody]Models.Northwind.CustomerDemographic newItem)
    {
        try
        {
            ...
            var itemToReturn = this.context.CustomerDemographics.Where(i => i.CustomerTypeID == key);
