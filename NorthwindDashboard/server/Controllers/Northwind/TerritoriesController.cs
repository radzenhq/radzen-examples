...
namespace Northwind.Controllers.Northwind
{
  ...
  public partial class TerritoriesController : ODataController
  {
    ...
    public SingleResult<Territory> GetTerritory(string key)
    {
        ...
        this.OnTerritoriesGet(ref items);

        return SingleResult.Create(items);
    }

    partial void OnTerritoriesGet(ref IQueryable<Models.Northwind.Territory> items);
    ...
    public IActionResult PutTerritory(string key, [FromBody]Models.Northwind.Territory newItem)
    {
        try
        {
            ...
            var itemToReturn = this.context.Territories.Where(i => i.TerritoryID == key);
