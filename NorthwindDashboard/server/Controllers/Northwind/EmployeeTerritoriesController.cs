...
namespace Northwind.Controllers.Northwind
{
  ...
  public partial class EmployeeTerritoriesController : ODataController
  {
    ...
    public SingleResult<EmployeeTerritory> GetEmployeeTerritory([FromODataUri] int keyEmployeeID,[FromODataUri] string keyTerritoryID)
    {
        ...
        this.OnEmployeeTerritoriesGet(ref items);

        return SingleResult.Create(items);
    }

    partial void OnEmployeeTerritoriesGet(ref IQueryable<Models.Northwind.EmployeeTerritory> items);
    ...
    public IActionResult PutEmployeeTerritory([FromODataUri] int keyEmployeeID,[FromODataUri] string keyTerritoryID, [FromBody]Models.Northwind.EmployeeTerritory newItem)
    {
        try
        {
            ...
            var itemToReturn = this.context.EmployeeTerritories.Where(i => i.EmployeeID == keyEmployeeID && i.TerritoryID == keyTerritoryID);
            Request.QueryString = Request.QueryString.Add("$expand", "Employee,Territory");
