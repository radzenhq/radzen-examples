...
namespace Northwind.Controllers.Northwind
{
  ...
  public partial class RegionsController : ODataController
  {
    ...
    public SingleResult<Region> GetRegion(int key)
    {
        ...
        this.OnRegionsGet(ref items);

        return SingleResult.Create(items);
    }

    partial void OnRegionsGet(ref IQueryable<Models.Northwind.Region> items);
    ...
    public IActionResult PutRegion(int key, [FromBody]Models.Northwind.Region newItem)
    {
        try
        {
            ...
            var itemToReturn = this.context.Regions.Where(i => i.RegionID == key);
