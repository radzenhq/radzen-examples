...
using CopyFileDeploy.Data;

namespace CopyFileDeploy
{
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new CopyFileDeploy.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new CopyFileDeploy.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<CopyFileDeploy.Data.SampleContext>(options =>
      {
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<CopyFileDeploy.Models.Sample.Order>("Orders");
          oDataBuilder.EntitySet<CopyFileDeploy.Models.Sample.OrderDetail>("OrderDetails");
          oDataBuilder.EntitySet<CopyFileDeploy.Models.Sample.Product>("Products");
