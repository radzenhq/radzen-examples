...
using AuditTrail.Authentication;
  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new AuditTrail.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new AuditTrail.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      {
         options.UseSqlServer(Configuration.GetConnectionString("AuditTrailDBConnection"));
      });
      ...
      services.AddDbContext<AuditTrail.Data.AuditTrailDbContext>(options =>
      {
        options.UseSqlServer(Configuration.GetConnectionString("AuditTrailDBConnection"));
      });
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<AuditTrail.Models.AuditTrailDb.Category>("Categories");
          ...
          builder.MapODataServiceRoute("odata/AuditTrailDB", "odata/AuditTrailDB", model);
