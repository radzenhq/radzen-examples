...
export class NorthwindService {
  ...
  getCategoryByCategoryId(expand: string | null, categoryId: number | null) {
    return this.odata.getById(`/Categories(${categoryId})`, { expand });
  }

  updateCategory(expand: string | null, categoryId: number | null, category: models.Category | null) {
  ...
  createCustomer(expand: string | null, customer: models.Customer | null) {
  ...
  getCustomerByCustomerId(expand: string | null, customerId: string | null) {
    return this.odata.getById(`/Customers('${encodeURIComponent(customerId)}')`, { expand });
  }

  updateCustomer(expand: string | null, customerId: string | null, customer: models.Customer | null) {
  ...
  createCustomerCustomerDemo(expand: string | null, customerCustomerDemo: models.CustomerCustomerDemo | null) {
  ...
  createCustomerDemographic(expand: string | null, customerDemographic: models.CustomerDemographic | null) {
  ...
  getCustomerDemographicByCustomerTypeId(expand: string | null, customerTypeId: string | null) {
    return this.odata.getById(`/CustomerDemographics('${encodeURIComponent(customerTypeId)}')`, { expand });
  }

  updateCustomerDemographic(expand: string | null, customerTypeId: string | null, customerDemographic: models.CustomerDemographic | null) {
  ...
  createEmployee(expand: string | null, employee: models.Employee | null) {
  ...
  getEmployeeByEmployeeId(expand: string | null, employeeId: number | null) {
    return this.odata.getById(`/Employees(${employeeId})`, { expand });
  }

  updateEmployee(expand: string | null, employeeId: number | null, employee: models.Employee | null) {
  ...
  createEmployeeTerritory(expand: string | null, employeeTerritory: models.EmployeeTerritory | null) {
  ...
  createOrder(expand: string | null, order: models.Order | null) {
  ...
  getOrderByOrderId(expand: string | null, orderId: number | null) {
    return this.odata.getById(`/Orders(${orderId})`, { expand });
  }

  updateOrder(expand: string | null, orderId: number | null, order: models.Order | null) {
  ...
  createOrderDetail(expand: string | null, orderDetail: models.OrderDetail | null) {
  ...
  createProduct(expand: string | null, product: models.Product | null) {
  ...
  getProductByProductId(expand: string | null, productId: number | null) {
    return this.odata.getById(`/Products(${productId})`, { expand });
  }

  updateProduct(expand: string | null, productId: number | null, product: models.Product | null) {
  ...
  createRegion(expand: string | null, region: models.Region | null) {
  ...
  getRegionByRegionId(expand: string | null, regionId: number | null) {
    return this.odata.getById(`/Regions(${regionId})`, { expand });
  }

  updateRegion(expand: string | null, regionId: number | null, region: models.Region | null) {
  ...
  createShipper(expand: string | null, shipper: models.Shipper | null) {
  ...
  getShipperByShipperId(expand: string | null, shipperId: number | null) {
    return this.odata.getById(`/Shippers(${shipperId})`, { expand });
  }

  updateShipper(expand: string | null, shipperId: number | null, shipper: models.Shipper | null) {
  ...
  createSupplier(expand: string | null, supplier: models.Supplier | null) {
  ...
  getSupplierBySupplierId(expand: string | null, supplierId: number | null) {
    return this.odata.getById(`/Suppliers(${supplierId})`, { expand });
  }

  updateSupplier(expand: string | null, supplierId: number | null, supplier: models.Supplier | null) {
  ...
  createTerritory(expand: string | null, territory: models.Territory | null) {
  ...
  getTerritoryByTerritoryId(expand: string | null, territoryId: string | null) {
    return this.odata.getById(`/Territories('${encodeURIComponent(territoryId)}')`, { expand });
  }

  updateTerritory(expand: string | null, territoryId: string | null, territory: models.Territory | null) {
  ...
  getCustomerCustomerDemoByCustomerIdAndCustomerTypeId(customerId: string | null, customerTypeId: string | null, expand: string | null) {
  ...
  updateCustomerCustomerDemo(customerId: string | null, customerTypeId: string | null, expand: string | null, customerCustomerDemo: models.CustomerCustomerDemo | null) {
  ...
  getEmployeeTerritoryByEmployeeIdAndTerritoryId(employeeId: number | null, territoryId: string | null, expand: string | null) {
    return this.odata.getById(`/EmployeeTerritories(EmployeeID=${employeeId},TerritoryID='${encodeURIComponent(territoryId)}')`, { expand });
  }

  updateEmployeeTerritory(employeeId: number | null, territoryId: string | null, expand: string | null, employeeTerritory: models.EmployeeTerritory | null) {
  ...
  getOrderDetailByOrderIdAndProductId(orderId: number | null, productId: number | null, expand: string | null) {
    return this.odata.getById(`/OrderDetails(OrderID=${orderId},ProductID=${productId})`, { expand });
  }

  updateOrderDetail(orderId: number | null, productId: number | null, expand: string | null, orderDetail: models.OrderDetail | null) {
