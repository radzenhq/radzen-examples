...
export class SampleService {
  ...
  getOrderById(expand: string | null, id: number | null) {
    return this.odata.getById(`/Orders(${id})`, { expand });
  }

  updateOrder(expand: string | null, id: number | null, order: models.Order | null) {
  ...
  getOrderDetailById(expand: string | null, id: number | null) {
    return this.odata.getById(`/OrderDetails(${id})`, { expand });
  }

  updateOrderDetail(expand: string | null, id: number | null, orderDetail: models.OrderDetail | null) {
  ...
  getProductById(expand: string | null, id: number | null) {
    return this.odata.getById(`/Products(${id})`, { expand });
  }

  updateProduct(expand: string | null, id: number | null, product: models.Product | null) {
