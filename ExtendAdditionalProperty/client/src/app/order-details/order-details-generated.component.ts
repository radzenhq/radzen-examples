...
export class OrderDetailsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getOrderDetails(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Order,Product`, null, null)
  ...
  grid0Delete(event: any) {
    this.northwind.deleteOrderDetail(event.OrderID, event.ProductID)
    .subscribe((result: any) => {
  ...
  grid0LoadData(event: any) {
    this.northwind.getOrderDetails(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Order,Product`, null, null)
    .subscribe((result: any) => {
      this.getOrderDetailsResult = result.value;
