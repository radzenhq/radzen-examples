...
namespace UploadFilesBlazor
{
    public partial class UploadController : Controller
    {
        ...
        private readonly UploadDbService service;

        public UploadController(IWebHostEnvironment environment, UploadDbService service)
        {
            ...
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    using (var stream = new FileStream(Path.Combine(environment.WebRootPath, name), FileMode.Create))
                    {
                        ...
                        await service.CreateFile(new Models.UploadDb.File { Name = name, Path = path });
                    }
                }
                return StatusCode(200);
            }
