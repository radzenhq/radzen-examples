...
export class NorthwindService {
  ...
  getApplicationUsers(filter: string | null, top: number | null, skip: number | null, orderby: string | null, expand: string | null, count: boolean | null) {
    return this.odata.get(`/ApplicationUsers`, { filter, top, skip, orderby, expand, count });
  }

  createApplicationUser(applicationUser: any) {
    return this.odata.post(`/ApplicationUsers`, applicationUser);
  }

  getApplicationUserById(id: string) {
    return this.odata.get(`/ApplicationUsers('${encodeURIComponent(id)}')`);
  }
  ...
  updateApplicationUser(id: string, applicationUser: any) {
    return this.odata.patch(`/ApplicationUsers('${encodeURIComponent(id)}')`, applicationUser, item => item.Id == id);
  }

  getApplicationRoles(filter: string | null, top: number | null, skip: number | null, orderby: string | null, expand: string | null, count: boolean | null) {
    return this.odata.get(`/ApplicationRoles`, { filter, top, skip, orderby, expand, count });
  }

  createIdentityRole(identityRole: any) {
    return this.odata.post(`/ApplicationRoles`, identityRole);
  }

  getIdentityRoleById(id: string) {
    return this.odata.get(`/ApplicationRoles('${encodeURIComponent(id)}')`);
  }
  ...
  updateIdentityRole(id: string, identityRole: any) {
