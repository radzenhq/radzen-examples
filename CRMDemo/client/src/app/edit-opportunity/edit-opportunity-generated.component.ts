/*
  ...
  Modify edit-opportunity.component.ts instead.
*/
...
export class EditOpportunityGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.crm.getOpportunityById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.crm.updateOpportunity(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Opportunity` });
    });
  }
}
