/*
  ...
  Modify edit-task-status.component.ts instead.
*/
...
export class EditTaskStatusGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.crm.getTaskStatusById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.crm.updateTaskStatus(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update TaskStatus` });
    });
  }
}
