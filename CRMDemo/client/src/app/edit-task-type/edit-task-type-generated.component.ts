/*
  ...
  Modify edit-task-type.component.ts instead.
*/
...
export class EditTaskTypeGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.crm.getTaskTypeById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.crm.updateTaskType(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update TaskType` });
    });
  }
}
