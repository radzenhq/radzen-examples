...
namespace CRMBlazorWasmRBS.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<CRMBlazorWasmRBS.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(CRMBlazorWasmRBS.Server.Models.ApplicationRole role)
        {
            try
            {
